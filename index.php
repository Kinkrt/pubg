...
<div class="menu-content" style="width: 40%;position: absolute;top: 12%;right: 1%"><span id="isinama" style="display: "><font size="2" id="latestTimer"></font></span></div>
</div>
<br>
...
<div class="popup-box">
<center>
<div class="popup-title"><span style="position: absolute;top: 25px;margin-left: 20px"><i class="fa fa-gift"></i> Reward Confirmation</span></div>
</center>
...
<button type="button" class="popup-btn-deactive" onmousedown="tutup.play();" onclick="close_reward_confirmation()"><font style="position: absolute;top: 2px;left: 40px">Cancel</font></button>
<button type="button" class="popup-btn-active" onmousedown="buka.play();" onclick="location.href='login.php'"><font style="position: absolute;top: 2px;left: 40px">Collect</font></button>
</div>
</div>
</div>
